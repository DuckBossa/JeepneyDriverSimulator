...
namespace UnityStandardAssets.Vehicles.Car
{
	...
	public class CarController : MonoBehaviour
	{
		...
		//normalized representation of the current speed within current gear's range
		...
		private void CalculateRevs()
		{
			...
			Debug.Log ("Current Gear: " + m_GearNum);
			Debug.Log ("Gear Factor: " + m_GearFactor);
...
//				m_WheelMeshes[i].transform.position = position;
				m_WheelMeshes[i].transform.rotation = Quaternion.Euler(new Vector3( quat.eulerAngles.z,90 + quat.eulerAngles.y,quat.eulerAngles.x));
			}
